...
<div class="container mx-auto p-6 max-w-4xl">
    <!-- Header Section -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Manage role</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
        ...
        <form action="{{ route('role.store') }}" method="POST" class="flex gap-3">
            @csrf
            <div class="flex-1">
                <input 
                    type="text" 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            ...
            <p class="text-gray-500 text-sm mt-1">{{ count($role) }} role total</p>
        </div>

        <div class="divide-y divide-gray-200">
            @forelse ($role as $program)
                <div class="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <form action="{{ route('role.destroy', $program->id) }}" method="POST" class="inline">
                            @csrf 
                            @method('DELETE')
                            <button type="submit" 
            ...
            @empty
                <div class="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p class="text-gray-500 mb-1">No role found</p>
